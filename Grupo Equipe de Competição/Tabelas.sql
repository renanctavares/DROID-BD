...
CREATE TABLE IF NOT EXISTS `mydb`.`Membro` (
  ...
  `Endereço_Bairro_Cidade_UF_ID Estado` INT NOT NULL,
  `Endereço_Tipo de Endereço_ID Tipo de Endereço` INT NOT NULL,
  PRIMARY KEY (`Matrícula`, `CPF`, `Equipe_CNPJ`, `Sexo_ID Sexo`, `Categoria_ID Categoria`, `País_ID País`, `Endereço_CEP`, `Endereço_ID Endereço`, `Endereço_Bairro_ID Bairro`, `Endereço_Bairro_Cidade_ID Cidade`, `Endereço_Bairro_Cidade_UF_ID Estado`, `Endereço_Tipo de Endereço_ID Tipo de Endereço`),
